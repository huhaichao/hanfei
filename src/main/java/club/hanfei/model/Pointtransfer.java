...
public final class Pointtransfer {
     ...
     */
    public static final int TRANSFER_SUM_C_INIT = Hanfei.getInt("pointInit");
     ...
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE = Hanfei.getInt("pointAddArticle");
     ...
     */
    public static final int TRANSFER_SUM_C_UPDATE_ARTICLE = Hanfei.getInt("pointUpdateArticle");
     ...
     */
    public static final int TRANSFER_SUM_C_ADD_COMMENT = Hanfei.getInt("pointAddComment");

    /**
     * Transfer sum - Add Self Article Comment.
     */
    public static final int TRANSFER_SUM_C_ADD_SELF_ARTICLE_COMMENT = Hanfei.getInt("pointAddSelfArticleComment");
     ...
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE_REWARD = Hanfei.getInt("pointAddArticleReward");
     ...
     */
    public static final int TRANSFER_SUM_C_INVITE_REGISTER = Hanfei.getInt("pointInviteRegister");
     ...
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_CHECKIN_MIN = Hanfei.getInt("pointActivityCheckinMin");

    /**
     * Transfer sum - Activity - Daily Checkin Max.
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_CHECKIN_MAX = Hanfei.getInt("pointActivityCheckinMax");
     ...
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_CHECKINT_STREAK = Hanfei.getInt("pointActivityCheckinStreak");
     ...
     * Transfer sum - Add Article.
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE_BROADCAST = Hanfei.getInt("pointAddArticleBroadcast");
     ...
     */
    public static final int TRANSFER_SUM_C_STICK_ARTICLE = Hanfei.getInt("pointStickArticle");
     ...
     */
    public static final int TRANSFER_SUM_C_AT_PARTICIPANTS = Hanfei.getInt("pointAtParticipants");
     ...
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_CHARACTER = Hanfei.getInt("pointActivityCharacter");
     ...
     */
    public static final int TRANSFER_SUM_C_ARTICLE_THANK = Hanfei.getInt("pointThankArticle");
     ...
     */
    public static final int TRANSFER_SUM_C_DATA_EXPORT = Hanfei.getInt("pointDataExport");
     ...
     */
    public static final int TRANSFER_SUM_C_BUY_INVITECODE = Hanfei.getInt("pointInvitecode");
     ...
     */
    public static final int TRANSFER_SUM_C_INVITECODE_USED = Hanfei.getInt("pointInvitecodeUsed");
     ...
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_EATINGSNAKE = Hanfei.getInt("pointActivityEatingSnake");
     ...
     */
    public static final int TRANSFER_SUM_C_PERFECT_ARTICLE = Hanfei.getInt("pointPerfectArticle");
     ...
     */
    public static final int TRANSFER_SUM_C_ACTIVITY_GOBANG_START = Hanfei.getInt("pointActivityGobang");
     ...
     */
    public static final int TRANSFER_SUM_C_UPDATE_COMMENT = Hanfei.getInt("pointUpdateComment");
     ...
     */
    public static final int TRANSFER_SUM_C_REPORT_HANDLED = Hanfei.getInt("pointReportHandled");
     ...
     */
    public static final int TRANSFER_SUM_C_CHANGE_USERNAME = Hanfei.getInt("pointChangeUsername");
