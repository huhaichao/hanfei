...
public final class Markdowns {
     ...
     */
    private static final int MD_TIMEOUT = Hanfei.getInt("markdown.timeout");
    ...
    public static String toHTML(final String markdownText) {
        ...
        final Callable<String> call = () -> {
            ...
            doc.select("a").forEach(a -> {
                ...
                if (StringUtils.startsWithAny(src, new String[]{Latkes.getServePath(), Hanfei.get("qiniu.domain")})
