...
import club.hanfei.repository.ReportRepository;
                ...
                switch (dataType) {
                    ...
                    case Report.REPORT_DATA_TYPE_C_COMMENT:
                        ...
                        if (null != comment) {
                            ...
                            reportData = commentQueryService.getCommentURL(commentId, cmtViewMode, Hanfei.getInt("articleCommentsPageSize"));
                        }
