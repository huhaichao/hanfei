...
public class DataModelService {
    ...
    public void fillRelevantArticles(final int avatarViewMode, final Map<String, Object> dataModel, final JSONObject article) {
        ...
        try {
            dataModel.put(Common.SIDE_RELEVANT_ARTICLES,
                    articleQueryService.getRelevantArticles(avatarViewMode, article, Hanfei.getInt("sideRelevantArticlesCnt")));
        } finally {
            Stopwatchs.end();
        }
    }
    ...
    public void fillLatestCmts(final Map<String, Object> dataModel) {
        ...
        try {
            // dataModel.put(Common.SIDE_LATEST_CMTS, commentQueryService.getLatestComments(Hanfei.getInt("sizeLatestCmtsCnt")));
    ...
    public void fillSideTags(final Map<String, Object> dataModel) {
        ...
        try {
            dataModel.put(Common.SIDE_TAGS, tagQueryService.getTags(Hanfei.getInt("sideTagsCnt")));
    ...
    public void fillIndexTags(final Map<String, Object> dataModel) {
        ...
        try {
            ...
            final List<JSONObject> tags = tagQueryService.getTags(Hanfei.getInt("sideTagsCnt"));
    ...
    private void fillHeader(final HttpServletRequest request, final HttpServletResponse response,
        ...
        dataModel.put("esEnabled", Hanfei.getBoolean("es.enabled"));
        dataModel.put("algoliaEnabled", Hanfei.getBoolean("algolia.enabled"));
        dataModel.put("algoliaAppId", Hanfei.get("algolia.appId"));
        dataModel.put("algoliaSearchKey", Hanfei.get("algolia.searchKey"));
        dataModel.put("algoliaIndex", Hanfei.get("algolia.index"));
    ...
    private void fillFooter(final Map<String, Object> dataModel) {
        ...
        dataModel.put(Common.SITE_VISIT_STAT_CODE, Hanfei.get(Common.SITE_VISIT_STAT_CODE));
        dataModel.put(Common.MOUSE_EFFECTS, RandomUtils.nextDouble() > 0.95);
        dataModel.put(Common.MACRO_HEAD_PC_CODE, Hanfei.get(Common.MACRO_HEAD_PC_CODE));
        dataModel.put(Common.MACRO_HEAD_MOBILE_CODE, Hanfei.get(Common.MACRO_HEAD_MOBILE_CODE));
        dataModel.put(Common.FOOTER_PC_CODE, Hanfei.get(Common.FOOTER_PC_CODE));
        dataModel.put(Common.FOOTER_MOBILE_CODE, Hanfei.get(Common.FOOTER_MOBILE_CODE));
        dataModel.put(Common.FOOTER_BEI_AN_HAO, Hanfei.get(Common.FOOTER_BEI_AN_HAO));
    }
    ...
    private void fillPersonalNav(final HttpServletRequest request, final HttpServletResponse response, final Map<String, Object> dataModel) {
        ...
        try {
            ...
            dataModel.put(Common.USE_CAPTCHA_CHECKIN, Hanfei.getBoolean("geetest.enabled"));
    ...
    private void fillTrendTags(final Map<String, Object> dataModel) {
        ...
        try {
            // dataModel.put(Common.NAV_TREND_TAGS, tagQueryService.getTrendTags(Hanfei.getInt("trendTagsCnt")));
    ...
    private void fillSysInfo(final Map<String, Object> dataModel) {
        dataModel.put(Common.VERSION, HanfeiServletListener.VERSION);
    }
}
