...
public class SearchMgmtService {
     ...
     */
    public static final String ES_SERVER = Hanfei.get("es.server");
    ...
    public void rebuildAlgoliaIndex() {
        ...
        final String appId = Hanfei.get("algolia.appId");
        final String index = Hanfei.get("algolia.index");
        final String key = Hanfei.get("algolia.adminKey");
