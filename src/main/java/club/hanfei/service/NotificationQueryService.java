    ...
    public JSONObject getCommentedNotifications(final int avatarViewMode, final String userId, final int currentPageNum, final int pageSize) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                final int cmtPage = commentQueryService.getCommentPage(articleId, commentId, cmtViewMode, Hanfei.getInt("articleCommentsPageSize"));
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                switch (dataType) {
                    ...
                    case Notification.DATA_TYPE_C_COMMENT_VOTE_DOWN:
                        ...
                        final String cmtVoteURL = commentQueryService.getCommentURL(commentId, cmtViewMode, Hanfei.getInt("articleCommentsPageSize"));
