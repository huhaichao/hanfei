...
import club.hanfei.util.Tesseracts;
...
public class ActivityMgmtService {
    ...
    public synchronized JSONObject collectEatingSnake(final String userId, final int score) {
        ...
        final int max = Hanfei.getInt("pointActivityEatingSnakeCollectMax");
    ...
    public synchronized JSONObject submitCharacter(final String userId, final String characterImg, final String character) {
        ...
        if (StringUtils.equals(character, recognizedCharacter)) {
            ...
            query.setFilter(CompositeFilterOperator.and(
                    ...
                    new PropertyFilter(Character.CHARACTER_CONTENT, FilterOperator.EQUAL, character)
            ));
            ...
            record.put(Character.CHARACTER_CONTENT, character);
            record.put(Character.CHARACTER_IMG, characterImg);
            record.put(Character.CHARACTER_USER_ID, userId);
