...
public class ArticleCache {
    ...
    static {
        ARTICLE_CACHE.setMaxCount(Hanfei.getInt("cache.articleCnt"));
        ARTICLE_ABSTRACT_CACHE.setMaxCount(Hanfei.getInt("cache.articleCnt"));
    }
    ...
    public void loadSideHotArticles() {
        ...
        try {
            ...
            final Query query = new Query().addSort(Article.ARTICLE_COMMENT_CNT, SortDirection.DESCENDING).
                    addSort(Keys.OBJECT_ID, SortDirection.ASCENDING).setCurrentPageNum(1).setPageSize(Hanfei.getInt("sideHotArticlesCnt"));
    ...
    public List<JSONObject> getSideRandomArticles() {
        int size = Hanfei.getInt("sideRandomArticlesCnt");
        if (1 > size) {
            return Collections.emptyList();
        }
    ...
    public void loadSideRandomArticles() {
        final int size = Hanfei.getInt("sideRandomArticlesCnt");
        if (1 > size) {
            return;
        }
    ...
    public void loadPerfectArticles() {
        ...
        try {
            final Query query = new Query()
                    ...
                    .setPageCount(1).setPageSize(Hanfei.getInt("indexPerfectCnt")).setCurrentPageNum(1);
