    ...
    public Template getTemplate(final boolean isSearchEngineBot, final JSONObject user) {
        ...
        try {
            ...
            try {
                ...
                if (Hanfei.get("skinDirName").equals(templateDirName) ||
                        Hanfei.get("mobileSkinDirName").equals(templateDirName)) {
                    throw e;
                }

                // Try to load default template
                ret = Skins.SKIN.getTemplate(Hanfei.get("skinDirName") + "/" + templateName);
            }
