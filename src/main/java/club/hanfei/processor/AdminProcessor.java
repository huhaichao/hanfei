...
import club.hanfei.service.DomainMgmtService;
...
import club.hanfei.service.OperationMgmtService;
import club.hanfei.service.OperationQueryService;
import club.hanfei.service.OptionMgmtService;
...
import club.hanfei.service.ReportQueryService;
import club.hanfei.service.RoleMgmtService;
import club.hanfei.service.RoleQueryService;
import club.hanfei.service.SearchMgmtService;
import club.hanfei.service.TagMgmtService;
...
public class AdminProcessor {
    ...
    public void exchangePoint(final RequestContext context) {
        ...
        try {
            ...
            if (currentPoint - point < Hanfei.getInt("pointExchangeMin")) {
                final AbstractFreeMarkerRenderer renderer = new SkinRenderer(request);
                context.setRenderer(renderer);
                renderer.setTemplateName("admin/error.ftl");
                final Map<String, Object> dataModel = renderer.getDataModel();
            ...
            final String memo = String.valueOf(Math.floor(point / (double) Hanfei.getInt("pointExchangeUnit")));
