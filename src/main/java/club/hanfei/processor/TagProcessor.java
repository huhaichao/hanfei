...
public class TagProcessor {
    ...
    public void showTagsWall(final RequestContext context) {
        ...
        final List<JSONObject> trendTags = tagQueryService.getTrendTags(Hanfei.getInt("tagsWallTrendCnt"));
        final List<JSONObject> coldTags = tagQueryService.getColdTags(Hanfei.getInt("tagsWallColdCnt"));
    ...
    public void showTagArticles(final RequestContext context) {
        ...
        final List<JSONObject> relatedTags = tagQueryService.getRelatedTags(tagId, Hanfei.getInt("tagRelatedTagsCnt"));
        ...
        tag.put(Tag.TAG_T_PARTICIPANTS, (Object) tagQueryService.getParticipants(avatarViewMode, tagId, Hanfei.getInt("tagParticipantsCnt")));

        final int tagRefCnt = tag.getInt(Tag.TAG_REFERENCE_CNT);
        final int pageCount = (int) Math.ceil(tagRefCnt / (double) pageSize);
        final int windowSize = Hanfei.getInt("tagArticlesWindowSize");
